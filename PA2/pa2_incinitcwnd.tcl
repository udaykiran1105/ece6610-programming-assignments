# GROUP 1 - TCL SCRIPT for RFC 3390 - increased initial CWND implementation

#
# Initialize Global Variables
#
set ns_		[new Simulator]
set tracefd     [open pa2_incinitcwnd.tr w]
...
# setting initial/reset window size to 4 packets
