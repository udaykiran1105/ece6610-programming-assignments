...
#define XILNET_ETH_1_BUF_SIZE                    ((1514 + 31) & 0xFFFFFFE0)      // Align parameter to a 32 byte boundary
#define XILNET_ETH_1_BUF_ALIGNMENT               4                             // Alignment of packet within the buffer

// Variables for ETH 1
extern XLlFifo              ETH_1_FIFO_Instance;

// Buffers for ETH 1
extern unsigned int ETH_1_recv_buffer[XILNET_ETH_1_NUM_RECV_BUF * (XILNET_ETH_1_BUF_SIZE >> 2)];
extern unsigned int ETH_1_send_buffer[(XILNET_ETH_1_BUF_SIZE >> 2)];
