...
typedef struct {
    ...
    uint32_t RX_PKT_RSSI_CD;
    uint32_t RX_PKT_RSSI_CD_n_bits;
    uint32_t RX_PKT_RSSI_CD_bin_pt;
    // uint32_t RX_PKT_RSSI_CD_attr;
    ...
    uint32_t PKTDET_DSSS_CONFIG;
    uint32_t PKTDET_DSSS_CONFIG_n_bits;
    uint32_t PKTDET_DSSS_CONFIG_bin_pt;
    // uint32_t PKTDET_DSSS_CONFIG_attr;
    ...
    uint32_t PKTBUF_MAX_WRITE_ADDR;
    uint32_t PKTBUF_MAX_WRITE_ADDR_n_bits;
    uint32_t PKTBUF_MAX_WRITE_ADDR_bin_pt;
    // uint32_t PKTBUF_MAX_WRITE_ADDR_attr;
    uint32_t FFT_Config;
