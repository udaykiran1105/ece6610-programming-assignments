...
proc generate {drv_handle} {
    puts "Generating Macros for wlan_mac_hw_axiw driver access ... "
    ...
    sg_lappend config_table addr_config_table "C_MEMMAP_BACKOFF_COUNTER"
    sg_lappend config_table xparam_config_table "C_MEMMAP_BACKOFF_COUNTER_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_BACKOFF_COUNTER_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_BACKOFF_COUNTER_ATTR"
    sg_lappend config_table addr_config_table "C_MEMMAP_PHY_RX_PARAMS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_PHY_RX_PARAMS_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_PHY_RX_PARAMS_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_PHY_RX_PARAMS_ATTR"
    ...
    sg_lappend config_table addr_config_table "C_MEMMAP_TX_CTRL_B_PARAMS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_B_PARAMS_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_B_PARAMS_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_B_PARAMS_ATTR"
    sg_lappend config_table addr_config_table "C_MEMMAP_TX_CTRL_A_GAINS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_A_GAINS_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_A_GAINS_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_A_GAINS_ATTR"
    sg_lappend config_table addr_config_table "C_MEMMAP_TX_CTRL_A_PARAMS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_A_PARAMS_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_A_PARAMS_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_A_PARAMS_ATTR"
    sg_lappend config_table addr_config_table "C_MEMMAP_POST_RX_TIMERS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_POST_RX_TIMERS_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_POST_RX_TIMERS_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_POST_RX_TIMERS_ATTR"
    sg_lappend config_table addr_config_table "C_MEMMAP_TX_CTRL_B_GAINS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_B_GAINS_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_B_GAINS_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_TX_CTRL_B_GAINS_ATTR"
    sg_lappend config_table addr_config_table "C_MEMMAP_POST_TX_TIMERS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_POST_TX_TIMERS_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_POST_TX_TIMERS_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_POST_TX_TIMERS_ATTR"
    ...
    sg_lappend config_table addr_config_table "C_MEMMAP_NAV_MATCH_ADDR_1"
    sg_lappend config_table xparam_config_table "C_MEMMAP_NAV_MATCH_ADDR_1_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_NAV_MATCH_ADDR_1_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_NAV_MATCH_ADDR_1_ATTR"
    sg_lappend config_table addr_config_table "C_MEMMAP_NAV_MATCH_ADDR_2"
    sg_lappend config_table xparam_config_table "C_MEMMAP_NAV_MATCH_ADDR_2_N_BITS"
    sg_lappend config_table xparam_config_table "C_MEMMAP_NAV_MATCH_ADDR_2_BIN_PT"
    # sg_lappend config_table xparam_config_table "C_MEMMAP_NAV_MATCH_ADDR_2_ATTR"
    ...
    eval xdefine_include_file $drv_handle "xparameters.h" "WLAN_MAC_HW_AXIW" "NUM_INSTANCES" ${xparam_config_table}
    eval sg_xdefine_include_file $drv_handle "xparameters.h" "WLAN_MAC_HW_AXIW" ${addr_config_table}
    # generate wlan_mac_hw_axiw_g.c
    eval xdefine_config_file $drv_handle "wlan_mac_hw_axiw_g.c" "WLAN_MAC_HW_AXIW" ${config_table}
}
...
proc sg_xdefine_include_file {drv_handle file_name drv_string args} {
    ...
    foreach periph ${periphs} {
        ...
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_CREATE    xc_wlan_mac_hw_axiw_create"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_RELEASE   xc_wlan_mac_hw_axiw_release"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_OPEN      xc_wlan_mac_hw_axiw_open"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_CLOSE     xc_wlan_mac_hw_axiw_close"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_READ      xc_wlan_mac_hw_axiw_read"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_WRITE     xc_wlan_mac_hw_axiw_write"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_GET_SHMEM xc_wlan_mac_hw_axiw_getshmem"
